#
#  Be sure to run `pod spec lint lib_bt.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "batianhu"
  # spec.authors            = { "batianhu" => "batianhu@123.com" }
  # spec.social_media_url   = "https://twitter.com/batianhu"
